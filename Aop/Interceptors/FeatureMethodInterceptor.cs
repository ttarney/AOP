...
{
    public class FeatureClassInterceptor : BaseInterceptor
    {
        private Type _type;
        public Type Type
        {
        ...
        /// </summary>
        public FeatureClassInterceptor(Type type) : base()
        {
            _type = type;
        ...
        public FeatureClassInterceptor(Action<IInvocation> invocationDelegate) : base(invocationDelegate)
        {
        }
